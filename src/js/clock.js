...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  function handleMouseMove(event){
    let hands = document.querySelectorAll(".A_Hand");
    let oClocks = document.querySelectorAll(".O_Clock");
    // получаем все эленты с классом .eye
    oClocks.forEach((oClock) => {
      let hand = oClock.querySelector(".A_Hand");
    ...
    let O_Clock = document.querySelector(".O_Clock");
...
// ПЕРЕХОД НА 20Е
document.querySelector('.Twenties').addEventListener('click', function () {
  const Main_Display_Time = document.querySelectorAll('.Main_Display_Time'); 
  const Twenties_Display_Time = document.querySelectorAll('.Twenties_Display_Time'); 
  const Clock_Main = document.querySelector('.Clock_Main');
  const Clock_2020 = document.querySelector('.Clock_2020')

  // Перебираем все элементы с классом .A_Time и скрываем их
  Main_Display_Time.forEach(element => {
    element.style.display = 'none'; // 'none' в кавычках
  });
  Clock_Main.style.display = 'none';

  Twenties_Display_Time.forEach(element => {
...
document.querySelectorAll('.Back_to_Main_Clock').forEach(e => {
...
function BackFunc() {
  ...
  const NineteenTen_Display_Time = document.querySelectorAll('.NineteenTen_Display_Time'); 
  const Clock_1910 = document.querySelector('.Clock_1910')

  const NineteenTwenty_Display_Time = document.querySelectorAll('.NineteenTwenty_Display_Time'); 
  const Clock_1920 = document.querySelector('.Clock_1920')

  const NineteenThirty_Display_Time = document.querySelectorAll('.NineteenThirty_Display_Time'); 
  const Clock_1930 = document.querySelector('.Clock_1930')

  const NineteenFourty_Display_Time = document.querySelectorAll('.NineteenFourty_Display_Time'); 
  const Clock_1940 = document.querySelector('.Clock_1940')

  const NineteenFifty_Display_Time = document.querySelectorAll('.NineteenFifty_Display_Time'); 
  const Clock_1950 = document.querySelector('.Clock_1950')

  const NineteenSixty_Display_Time = document.querySelectorAll('.NineteenSixty_Display_Time'); 
  const Clock_1960 = document.querySelector('.Clock_1960')

  const NineteenSeventy_Display_Time = document.querySelectorAll('.NineteenSeventy_Display_Time'); 
  const Clock_1970 = document.querySelector('.Clock_1970')

  const NineteenEighty_Display_Time = document.querySelectorAll('.NineteenEighty_Display_Time'); 
  const Clock_1980 = document.querySelector('.Clock_1980')

  const NineteenNinety_Display_Time = document.querySelectorAll('.NineteenNinety_Display_Time'); 
  const Clock_1990 = document.querySelector('.Clock_1990')

  const TwoThousand_Display_Time = document.querySelectorAll('.TwoThousand_Display_Time'); 
  const Clock_2000 = document.querySelector('.Clock_2000')

  const TwentyTen_Display_Time = document.querySelectorAll('.TwentyTen_Display_Time'); 
  const Clock_2010 = document.querySelector('.Clock_2010')
  ...
  NineteenTen_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1910.style.display = 'none'

  NineteenTwenty_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1920.style.display = 'none'

  NineteenThirty_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1930.style.display = 'none'

  NineteenFourty_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1940.style.display = 'none'

  NineteenFifty_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1950.style.display = 'none'

  NineteenSixty_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1960.style.display = 'none'

  NineteenSeventy_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1970.style.display = 'none'

  NineteenEighty_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1980.style.display = 'none'

  NineteenNinety_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_1990.style.display = 'none'

  TwoThousand_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
  Clock_2000.style.display = 'none'

  TwentyTen_Display_Time.forEach(element => {
    element.style.display = 'none'
  });
