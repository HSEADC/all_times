...
(() => {
"use strict";
/* harmony import */ var _search_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(782);
...
document.addEventListener('DOMContentLoaded', function () {
  (0,_search_data_js__WEBPACK_IMPORTED_MODULE_0__/* .getManifests */ .R)().then(function (data) {
    //обновление данных
    // update(data)
    content = data;
    initSearch();
